var XmlDSigJs = (function (exports) {
  ...
  var XmlCollection = function (_XmlObject) {
    ...
    _createClass(XmlCollection, [{
      ...
      key: "OnGetXml",
      value: function OnGetXml(element) {
        var _iterator = _createForOfIteratorHelper(this.GetIterator()),
            _step;
  ...
  function bufferToHexCodes(inputBuffer) {
    ...
    var _iterator2 = _createForOfIteratorHelper(new Uint8Array(inputBuffer, inputOffset, inputLength)),
        _step2;
  ...
  function arrayBufferToString(buffer) {
    ...
    var _iterator3 = _createForOfIteratorHelper(view),
        _step3;
  ...
  function clearProps(object, propsArray) {
    var _iterator4 = _createForOfIteratorHelper(propsArray),
        _step4;
      ...
      value: function decryptEncryptedContentInfo(parameters) {
        ...
        sequence = sequence.then(function (result) {
          ...
          if (parameters.encryptedContentInfo.encryptedContent.idBlock.isConstructed === false) dataBuffer = parameters.encryptedContentInfo.encryptedContent.valueBlock.valueHex;else {
            var _iterator5 = _createForOfIteratorHelper(parameters.encryptedContentInfo.encryptedContent.valueBlock.value),
                _step5;
      ...
      value: function isEqual(compareTo) {
        ...
        if (compareTo.constructor.blockName() === AttributeTypeAndValue.blockName()) {
          ...
          if (thisName === compareTo.value.constructor.blockName()) {
            var _iterator6 = _createForOfIteratorHelper(stringBlockNames),
                _step6;
    ...
    _createClass(RelativeDistinguishedNames, [{
      ...
      value: function isEqual(compareTo) {
        if (compareTo instanceof RelativeDistinguishedNames) {
          ...
          var _iterator7 = _createForOfIteratorHelper(this.typesAndValues.entries()),
              _step7;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _iterator8 = _createForOfIteratorHelper(logs);
                  _context.prev = 5;
  ...
  var SignedCertificateTimestampList = function () {
    ...
    _createClass(SignedCertificateTimestampList, [{
      ...
      value: function toSchema() {
        ...
        var _iterator9 = _createForOfIteratorHelper(this.timestamps),
            _step9;

        try {
          for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
            var _timestamp = _step9.value;
        ...
        for (var _i34 = 0, _timestampsData = timestampsData; _i34 < _timestampsData.length; _i34++) {
          var timestamp = _timestampsData[_i34];
  ...
  var XmlDsigEnvelopedSignatureTransform = function (_Transform3) {
    ...
    _createClass(XmlDsigEnvelopedSignatureTransform, [{
      ...
      value: function GetOutput() {
        ...
        for (var _i35 = 0, _signatures = signatures; _i35 < _signatures.length; _i35++) {
          var signature = _signatures[_i35];
  ...
  exports.KeyValue = function (_KeyInfoClause3) {
    ...
    _createClass(KeyValue, [{
      ...
      value: function OnLoadXml(element) {
        ...
        for (var _i36 = 0, _keyValueTypes = keyValueTypes; _i36 < _keyValueTypes.length; _i36++) {
          var keyValueType = _keyValueTypes[_i36];
  ...
  function bufferToHexCodes$1(inputBuffer) {
    ...
    var _iterator10 = _createForOfIteratorHelper(new Uint8Array(inputBuffer, inputOffset, inputLength)),
        _step10;
  ...
  function utilConcatBuf$1() {
    ...
    for (var _len7 = arguments.length, buffers = new Array(_len7), _key12 = 0; _key12 < _len7; _key12++) {
      buffers[_key12] = arguments[_key12];
    }

    for (var _i37 = 0, _buffers3 = buffers; _i37 < _buffers3.length; _i37++) {
      var buffer = _buffers3[_i37];
      outputLength += buffer.byteLength;
    }
    ...
    for (var _i38 = 0, _buffers4 = buffers; _i38 < _buffers4.length; _i38++) {
      var _buffer3 = _buffers4[_i38];
  ...
  function utilConcatView$1() {
    ...
    for (var _len8 = arguments.length, views = new Array(_len8), _key13 = 0; _key13 < _len8; _key13++) {
      views[_key13] = arguments[_key13];
    }

    for (var _i39 = 0, _views3 = views; _i39 < _views3.length; _i39++) {
      var view = _views3[_i39];
      outputLength += view.length;
    }
    ...
    for (var _i40 = 0, _views4 = views; _i40 < _views4.length; _i40++) {
      var _view8 = _views4[_i40];
  ...
  function toBase64$1(input) {
    ...
    if (skipLeadingZeros) {
      ...
      for (var _i41 = 0; _i41 < input.length; _i41++) {
        if (input.charCodeAt(_i41) !== 0) {
          nonZeroPosition = _i41;
          break;
        }
      }
  ...
  function fromBase64$1(input) {
    ...
    function indexof(toSearch) {
      for (var _i42 = 0; _i42 < 64; _i42++) {
        if (template.charAt(_i42) === toSearch) return _i42;
      }
    ...
    if (cutTailZeros) {
      ...
      for (var _i43 = outputLength - 1; _i43 >= 0; _i43--) {
        if (output.charCodeAt(_i43) !== 0) {
          nonZeroStart = _i43;
          break;
        }
      }
  ...
  function arrayBufferToString$1(buffer) {
    ...
    var _iterator11 = _createForOfIteratorHelper(view),
        _step11;
  ...
  function clearProps$1(object, propsArray) {
    var _iterator12 = _createForOfIteratorHelper(propsArray),
        _step12;
  ...
  var asn1$1 = createCommonjsModule(function (module, exports) {
    ...
    var LocalBaseBlock = function () {
      function LocalBaseBlock() {
        ...
        this.blockLength = (0, utils$1.getParametersValue)(parameters, "blockLength", 0);
        this.error = (0, utils$1.getParametersValue)(parameters, "error", "");
        this.warnings = (0, utils$1.getParametersValue)(parameters, "warnings", []);
        if ("valueBeforeDecode" in parameters) this.valueBeforeDecode = parameters.valueBeforeDecode.slice(0);else this.valueBeforeDecode = new ArrayBuffer(0);
      }
      ...
      _createClass(LocalBaseBlock, [{
        ...
        value: function toJSON() {
          return {
            ...
            error: this.error,
            warnings: this.warnings,
            valueBeforeDecode: (0, utils$1.bufferToHexCodes)(this.valueBeforeDecode, 0, this.valueBeforeDecode.byteLength)
          };
        }
      }], [{
        key: "blockName",
    ...
    var HexBlock = function HexBlock(BaseClass) {
      return function (_BaseClass2) {
        ...
        var _super115 = _createSuper(LocalHexBlockMixin);
        ...
        function LocalHexBlockMixin() {
          ...
          _this105 = _super115.call(this, parameters);
          _this105.isHexOnly = (0, utils$1.getParametersValue)(parameters, "isHexOnly", false);
          if ("valueHex" in parameters) _this105.valueHex = parameters.valueHex.slice(0);else _this105.valueHex = new ArrayBuffer(0);
          return _this105;
        }
        ...
        _createClass(LocalHexBlockMixin, [{
          key: "fromBER",
          value: function fromBER(inputBuffer, inputOffset, inputLength) {
            if ((0, utils$1.checkBufferParams)(this, inputBuffer, inputOffset, inputLength) === false) return -1;
            var intBuffer = new Uint8Array(inputBuffer, inputOffset, inputLength);
          ...
          value: function toJSON() {
            ...
            object.blockName = this.constructor.blockName();
            object.isHexOnly = this.isHexOnly;
            object.valueHex = (0, utils$1.bufferToHexCodes)(this.valueHex, 0, this.valueHex.byteLength);
            return object;
          }
        }], [{
          key: "blockName",
    ...
    var LocalIdentificationBlock = function (_HexBlock11) {
      ...
      var _super116 = _createSuper(LocalIdentificationBlock);
      ...
      function LocalIdentificationBlock() {
        ...
        _this106 = _super116.call(this);

        if ("idBlock" in parameters) {
          _this106.isHexOnly = (0, utils$1.getParametersValue)(parameters.idBlock, "isHexOnly", false);
          _this106.valueHex = (0, utils$1.getParametersValue)(parameters.idBlock, "valueHex", new ArrayBuffer(0));
          _this106.tagClass = (0, utils$1.getParametersValue)(parameters.idBlock, "tagClass", -1);
          _this106.tagNumber = (0, utils$1.getParametersValue)(parameters.idBlock, "tagNumber", -1);
          _this106.isConstructed = (0, utils$1.getParametersValue)(parameters.idBlock, "isConstructed", false);
        } else {
          _this106.tagClass = -1;
          _this106.tagNumber = -1;
          _this106.isConstructed = false;
        }
      ...
      _createClass(LocalIdentificationBlock, [{
        ...
        value: function toBER() {
          ...
          if (this.isHexOnly === false) {
            var encodedBuf = (0, utils$1.utilToBase)(this.tagNumber, 7);
            var encodedView = new Uint8Array(encodedBuf);
            var size = encodedBuf.byteLength;
            retBuf = new ArrayBuffer(size + 1);
            retView = new Uint8Array(retBuf);
          ...
          if (sizeOnly === false) {
            ...
            for (var _i44 = 0; _i44 < curView.length - 1; _i44++) {
              retView[_i44 + 1] = curView[_i44] | 0x80;
            }
        ...
        value: function fromBER(inputBuffer, inputOffset, inputLength) {
          ...
          if (tagNumberMask !== 0x1F) {
            ...
            this.blockLength = 1;
              ...
              for (var _i45 = 0; _i45 < count; _i45++) {
                tempBufferView[_i45] = intTagNumberBuffer[_i45];
              }

              this.valueHex = new ArrayBuffer(count);
              intTagNumberBuffer = new Uint8Array(this.valueHex);
              intTagNumberBuffer.set(tempBufferView);
              if (this.blockLength <= 9) this.tagNumber = (0, utils$1.utilFromBase)(intTagNumberBuffer, 7);else {
                this.isHexOnly = true;
                this.warnings.push("Tag too long, represented as hex-coded");
              }
            }
    ...
    var LocalLengthBlock = function (_LocalBaseBlock4) {
      ...
      var _super117 = _createSuper(LocalLengthBlock);
      ...
      function LocalLengthBlock() {
        ...
        _this107 = _super117.call(this);

        if ("lenBlock" in parameters) {
          _this107.isIndefiniteForm = (0, utils$1.getParametersValue)(parameters.lenBlock, "isIndefiniteForm", false);
          _this107.longFormUsed = (0, utils$1.getParametersValue)(parameters.lenBlock, "longFormUsed", false);
          _this107.length = (0, utils$1.getParametersValue)(parameters.lenBlock, "length", 0);
        } else {
          _this107.isIndefiniteForm = false;
          _this107.longFormUsed = false;
          _this107.length = 0;
        }
      ...
      _createClass(LocalLengthBlock, [{
        ...
        value: function fromBER(inputBuffer, inputOffset, inputLength) {
          ...
          if (lengthBufferView[count - 1] === 0x00) this.warnings.push("Needlessly long encoded length");
          this.length = (0, utils$1.utilFromBase)(lengthBufferView, 8);
          if (this.longFormUsed && this.length <= 127) this.warnings.push("Unneccesary usage of long length form");
          this.blockLength = count + 1;
          return inputOffset + this.blockLength;
        }
        ...
        value: function toBER() {
          ...
          if (this.longFormUsed === true) {
            var encodedBuf = (0, utils$1.utilToBase)(this.length, 8);
    ...
    var ValueBlock = function (_LocalBaseBlock5) {
      ...
      var _super118 = _createSuper(ValueBlock);
      ...
      function ValueBlock() {
        ...
        return _super118.call(this, parameters);
      }
    ...
    var BaseBlock = function (_LocalBaseBlock6) {
      ...
      var _super119 = _createSuper(BaseBlock);
      ...
      function BaseBlock() {
        ...
        _this108 = _super119.call(this, parameters);
        if ("name" in parameters) _this108.name = parameters.name;
        if ("optional" in parameters) _this108.optional = parameters.optional;
        if ("primitiveSchema" in parameters) _this108.primitiveSchema = parameters.primitiveSchema;
        _this108.idBlock = new LocalIdentificationBlock(parameters);
        _this108.lenBlock = new LocalLengthBlock(parameters);
        _this108.valueBlock = new valueBlockType(parameters);
        return _this108;
      }
      ...
      _createClass(BaseBlock, [{
        ...
        value: function toBER() {
          ...
          this.lenBlock.length = valueBlockSizeBuf.byteLength;
          var lenBlockBuf = this.lenBlock.toBER(sizeOnly);
          retBuf = (0, utils$1.utilConcatBuf)(idBlockBuf, lenBlockBuf);
          var valueBlockBuf;
          if (sizeOnly === false) valueBlockBuf = this.valueBlock.toBER(sizeOnly);else valueBlockBuf = new ArrayBuffer(this.lenBlock.length);
          retBuf = (0, utils$1.utilConcatBuf)(retBuf, valueBlockBuf);
          ...
          if (this.lenBlock.isIndefiniteForm === true) {
            ...
            retBuf = (0, utils$1.utilConcatBuf)(retBuf, indefBuf);
          }
    ...
    var LocalPrimitiveValueBlock = function (_ValueBlock7) {
      ...
      var _super120 = _createSuper(LocalPrimitiveValueBlock);
      ...
      function LocalPrimitiveValueBlock() {
        ...
        _this109 = _super120.call(this, parameters);
        if ("valueHex" in parameters) _this109.valueHex = parameters.valueHex.slice(0);else _this109.valueHex = new ArrayBuffer(0);
        _this109.isHexOnly = (0, utils$1.getParametersValue)(parameters, "isHexOnly", true);
        return _this109;
      }
    ...
    var Primitive = function (_BaseBlock15) {
      ...
      var _super121 = _createSuper(Primitive);
      ...
      function Primitive() {
        ...
        _this110 = _super121.call(this, parameters, LocalPrimitiveValueBlock);
        _this110.idBlock.isConstructed = false;
        return _this110;
      }
    ...
    var LocalConstructedValueBlock = function (_ValueBlock8) {
      ...
      var _super122 = _createSuper(LocalConstructedValueBlock);
      ...
      function LocalConstructedValueBlock() {
        ...
        _this111 = _super122.call(this, parameters);
        _this111.value = (0, utils$1.getParametersValue)(parameters, "value", []);
        _this111.isIndefiniteForm = (0, utils$1.getParametersValue)(parameters, "isIndefiniteForm", false);
        return _this111;
      }
      ...
      _createClass(LocalConstructedValueBlock, [{
        ...
        value: function toBER() {
          ...
          for (var i = 0; i < this.value.length; i++) {
            var valueBuf = this.value[i].toBER(sizeOnly);
            retBuf = (0, utils$1.utilConcatBuf)(retBuf, valueBuf);
          }
    ...
    var Constructed = function (_BaseBlock16) {
      ...
      var _super123 = _createSuper(Constructed);
      ...
      function Constructed() {
        ...
        _this112 = _super123.call(this, parameters, LocalConstructedValueBlock);
        _this112.idBlock.isConstructed = true;
        return _this112;
      }
    ...
    var LocalEndOfContentValueBlock = function (_ValueBlock9) {
      ...
      var _super124 = _createSuper(LocalEndOfContentValueBlock);
      ...
      function LocalEndOfContentValueBlock() {
        ...
        return _super124.call(this, parameters);
      }
    ...
    var EndOfContent = function (_BaseBlock17) {
      ...
      var _super125 = _createSuper(EndOfContent);
      ...
      function EndOfContent() {
        ...
        _this113 = _super125.call(this, paramaters, LocalEndOfContentValueBlock);
        _this113.idBlock.tagClass = 1;
        _this113.idBlock.tagNumber = 0;
        return _this113;
      }
    ...
    var LocalBooleanValueBlock = function (_ValueBlock10) {
      ...
      var _super126 = _createSuper(LocalBooleanValueBlock);
      ...
      function LocalBooleanValueBlock() {
        ...
        _this114 = _super126.call(this, parameters);
        _this114.value = (0, utils$1.getParametersValue)(parameters, "value", false);
        _this114.isHexOnly = (0, utils$1.getParametersValue)(parameters, "isHexOnly", false);
        if ("valueHex" in parameters) _this114.valueHex = parameters.valueHex.slice(0);else {
          _this114.valueHex = new ArrayBuffer(1);

          if (_this114.value === true) {
            var view = new Uint8Array(_this114.valueHex);
            view[0] = 0xFF;
          }
        }
        return _this114;
      ...
      _createClass(LocalBooleanValueBlock, [{
        ...
        value: function fromBER(inputBuffer, inputOffset, inputLength) {
          ...
          if (utils$1.utilDecodeTC.call(this) !== 0) this.value = true;else this.value = false;
          this.blockLength = inputLength;
          return inputOffset + inputLength;
        }
      }, {
    ...
    var Boolean = function (_BaseBlock18) {
      ...
      var _super127 = _createSuper(Boolean);
      ...
      function Boolean() {
        ...
        _this115 = _super127.call(this, parameters, LocalBooleanValueBlock);
        _this115.idBlock.tagClass = 1;
        _this115.idBlock.tagNumber = 1;
        return _this115;
      }
    ...
    var Sequence = function (_Constructed3) {
      ...
      var _super128 = _createSuper(Sequence);
      ...
      function Sequence() {
        ...
        _this116 = _super128.call(this, parameters);
        _this116.idBlock.tagClass = 1;
        _this116.idBlock.tagNumber = 16;
        return _this116;
      }
    ...
    var Set = function (_Constructed4) {
      ...
      var _super129 = _createSuper(Set);
      ...
      function Set() {
        ...
        _this117 = _super129.call(this, parameters);
        _this117.idBlock.tagClass = 1;
        _this117.idBlock.tagNumber = 17;
        return _this117;
      }
    ...
    var Null = function (_BaseBlock19) {
      ...
      var _super130 = _createSuper(Null);
      ...
      function Null() {
        ...
        _this118 = _super130.call(this, parameters, LocalBaseBlock);
        _this118.idBlock.tagClass = 1;
        _this118.idBlock.tagNumber = 5;
        return _this118;
      }
    ...
    var LocalOctetStringValueBlock = function (_HexBlock12) {
      ...
      var _super131 = _createSuper(LocalOctetStringValueBlock);
      ...
      function LocalOctetStringValueBlock() {
        ...
        _this119 = _super131.call(this, parameters);
        _this119.isConstructed = (0, utils$1.getParametersValue)(parameters, "isConstructed", false);
        return _this119;
      }
    ...
    var OctetString = function (_BaseBlock20) {
      ...
      var _super132 = _createSuper(OctetString);
      ...
      function OctetString() {
        ...
        _this120 = _super132.call(this, parameters, LocalOctetStringValueBlock);
        _this120.idBlock.tagClass = 1;
        _this120.idBlock.tagNumber = 4;
        return _this120;
      }
    ...
    var LocalBitStringValueBlock = function (_HexBlock13) {
      ...
      var _super133 = _createSuper(LocalBitStringValueBlock);
      ...
      function LocalBitStringValueBlock() {
        ...
        _this121 = _super133.call(this, parameters);
        _this121.unusedBits = (0, utils$1.getParametersValue)(parameters, "unusedBits", 0);
        _this121.isConstructed = (0, utils$1.getParametersValue)(parameters, "isConstructed", false);
        _this121.blockLength = _this121.valueHex.byteLength;
        return _this121;
      }
      ...
      _createClass(LocalBitStringValueBlock, [{
        ...
        value: function fromBER(inputBuffer, inputOffset, inputLength) {
          ...
          for (var _i46 = 0; _i46 < inputLength - 1; _i46++) {
            view[_i46] = intBuffer[_i46 + 1];
          }
    ...
    var BitString = function (_BaseBlock21) {
      ...
      var _super134 = _createSuper(BitString);
      ...
      function BitString() {
        ...
        _this122 = _super134.call(this, parameters, LocalBitStringValueBlock);
        _this122.idBlock.tagClass = 1;
        _this122.idBlock.tagNumber = 3;
        return _this122;
      }
    ...
    var LocalIntegerValueBlock = function (_HexBlock14) {
      ...
      var _super135 = _createSuper(LocalIntegerValueBlock);
      ...
      function LocalIntegerValueBlock() {
        ...
        _this123 = _super135.call(this, parameters);
        if ("value" in parameters) _this123.valueDec = parameters.value;
        return _this123;
      }
      ...
      _createClass(LocalIntegerValueBlock, [{
        ...
        value: function toString() {
          function viewAdd(first, second) {
            ...
            for (var i = max; i >= 0; i--, counter++) {
              ...
              switch (true) {
                case counter >= firstViewCopy.length:
                  firstViewCopy = (0, utils$1.utilConcatView)(new Uint8Array([value % 10]), firstViewCopy);
                  break;
            ...
            if (c[0] > 0) firstViewCopy = (0, utils$1.utilConcatView)(c, firstViewCopy);
            return firstViewCopy.slice(0);
          }
          ...
          function power2(n) {
            if (n >= powers2.length) {
              for (var p = powers2.length; p <= n; p++) {
                ...
                if (c[0] > 0) _digits2 = (0, utils$1.utilConcatView)(c, _digits2);
          ...
          function viewSub(first, second) {
            ...
            if (b > 0) {
              for (var _i47 = firstViewCopyLength - secondViewCopyLength + 1; _i47 >= 0; _i47--, counter++) {
                value = firstViewCopy[firstViewCopyLength - counter] - b;
          ...
          for (var _i48 = 0; _i48 < digits.length; _i48++) {
            if (digits[_i48]) flag = true;
            if (flag) result += digitsString.charAt(digits[_i48]);
          }
        ...
        set: function set(_value) {
          ...
          if (_value.byteLength >= 4) {
            ...
            this.isHexOnly = false;
            if (_value.byteLength > 0) this._valueDec = utils$1.utilDecodeTC.call(this);
          }
        },
        get: function get() {
          return this._valueHex;
        ...
        set: function set(_value) {
          this._valueDec = _value;
          this.isHexOnly = false;
          this._valueHex = (0, utils$1.utilEncodeTC)(_value);
        },
        get: function get() {
          return this._valueDec;
        }
    ...
    var Integer = function (_BaseBlock22) {
      ...
      var _super136 = _createSuper(Integer);
      ...
      function Integer() {
        ...
        _this124 = _super136.call(this, parameters, LocalIntegerValueBlock);
        _this124.idBlock.tagClass = 1;
        _this124.idBlock.tagNumber = 2;
        return _this124;
      }
      ...
      _createClass(Integer, [{
        ...
        value: function isEqual(otherValue) {
          if (otherValue instanceof Integer) {
            if (this.valueBlock.isHexOnly && otherValue.valueBlock.isHexOnly) return (0, utils$1.isEqualBuffer)(this.valueBlock.valueHex, otherValue.valueBlock.valueHex);
            if (this.valueBlock.isHexOnly === otherValue.valueBlock.isHexOnly) return this.valueBlock.valueDec === otherValue.valueBlock.valueDec;
            return false;
          }

          if (otherValue instanceof ArrayBuffer) return (0, utils$1.isEqualBuffer)(this.valueBlock.valueHex, otherValue);
          return false;
        }
      }, {
        key: "convertToDER",
    ...
    var Enumerated = function (_Integer2) {
      ...
      var _super137 = _createSuper(Enumerated);
      ...
      function Enumerated() {
        ...
        _this125 = _super137.call(this, parameters);
        _this125.idBlock.tagClass = 1;
        _this125.idBlock.tagNumber = 10;
        return _this125;
      }
    ...
    var LocalSidValueBlock = function (_HexBlock15) {
      ...
      var _super138 = _createSuper(LocalSidValueBlock);
      ...
      function LocalSidValueBlock() {
        ...
        _this126 = _super138.call(this, parameters);
        _this126.valueDec = (0, utils$1.getParametersValue)(parameters, "valueDec", -1);
        _this126.isFirstSid = (0, utils$1.getParametersValue)(parameters, "isFirstSid", false);
        return _this126;
      }
      ...
      _createClass(LocalSidValueBlock, [{
        ...
        value: function fromBER(inputBuffer, inputOffset, inputLength) {
          ...
          for (var _i49 = 0; _i49 < this.blockLength; _i49++) {
            tempView[_i49] = view[_i49];
          }
          ...
          if (view[0] === 0x00) this.warnings.push("Needlessly long format of SID encoding");
          if (this.blockLength <= 8) this.valueDec = (0, utils$1.utilFromBase)(view, 7);else {
            this.isHexOnly = true;
            this.warnings.push("Too big SID for decoding, hex only");
          }
          return inputOffset + this.blockLength;
        ...
        value: function toBER() {
          ...
          var encodedBuf = (0, utils$1.utilToBase)(this.valueDec, 7);
          ...
          if (sizeOnly === false) {
            ...
            for (var _i50 = 0; _i50 < encodedBuf.byteLength - 1; _i50++) {
              retView[_i50] = encodedView[_i50] | 0x80;
            }
        ...
        value: function toString() {
          var result = "";
          if (this.isHexOnly === true) result = (0, utils$1.bufferToHexCodes)(this.valueHex, 0, this.valueHex.byteLength);else {
            if (this.isFirstSid) {
              var sidValue = this.valueDec;
              if (this.valueDec <= 39) result = "0.";else {
                if (this.valueDec <= 79) {
    ...
    var LocalObjectIdentifierValueBlock = function (_ValueBlock11) {
      ...
      var _super139 = _createSuper(LocalObjectIdentifierValueBlock);
      ...
      function LocalObjectIdentifierValueBlock() {
        ...
        _this127 = _super139.call(this, parameters);

        _this127.fromString((0, utils$1.getParametersValue)(parameters, "value", ""));
    ...
    var ObjectIdentifier = function (_BaseBlock23) {
      ...
      var _super140 = _createSuper(ObjectIdentifier);
      ...
      function ObjectIdentifier() {
        ...
        _this128 = _super140.call(this, parameters, LocalObjectIdentifierValueBlock);
        _this128.idBlock.tagClass = 1;
        _this128.idBlock.tagNumber = 6;
        return _this128;
      }
    ...
    var LocalUtf8StringValueBlock = function (_HexBlock16) {
      ...
      var _super141 = _createSuper(LocalUtf8StringValueBlock);
      ...
      function LocalUtf8StringValueBlock() {
        ...
        _this129 = _super141.call(this, parameters);
        _this129.isHexOnly = true;
        _this129.value = "";
        return _this129;
      }
    ...
    var Utf8String = function (_BaseBlock24) {
      ...
      var _super142 = _createSuper(Utf8String);
      ...
      function Utf8String() {
        ...
        _this130 = _super142.call(this, parameters, LocalUtf8StringValueBlock);
        if ("value" in parameters) _this130.fromString(parameters.value);
        _this130.idBlock.tagClass = 1;
        _this130.idBlock.tagNumber = 12;
        return _this130;
      }
    ...
    var LocalRelativeSidValueBlock = function (_HexBlock17) {
      ...
      var _super143 = _createSuper(LocalRelativeSidValueBlock);
      ...
      function LocalRelativeSidValueBlock() {
        ...
        _this131 = _super143.call(this, parameters);
        _this131.valueDec = (0, utils$1.getParametersValue)(parameters, "valueDec", -1);
        return _this131;
      }
      ...
      _createClass(LocalRelativeSidValueBlock, [{
        ...
        value: function fromBER(inputBuffer, inputOffset, inputLength) {
          ...
          for (var _i51 = 0; _i51 < this.blockLength; _i51++) {
            tempView[_i51] = view[_i51];
          }
        ...
        value: function toBER() {
          ...
          if (sizeOnly === false) {
            ...
            for (var _i52 = 0; _i52 < encodedBuf.byteLength - 1; _i52++) {
              retView[_i52] = encodedView[_i52] | 0x80;
            }
    ...
    var LocalRelativeObjectIdentifierValueBlock = function (_ValueBlock12) {
      ...
      var _super144 = _createSuper(LocalRelativeObjectIdentifierValueBlock);
      ...
      function LocalRelativeObjectIdentifierValueBlock() {
        ...
        _this132 = _super144.call(this, parameters);

        _this132.fromString((0, utils$1.getParametersValue)(parameters, "value", ""));
    ...
    var RelativeObjectIdentifier = function (_BaseBlock25) {
      ...
      var _super145 = _createSuper(RelativeObjectIdentifier);
      ...
      function RelativeObjectIdentifier() {
        ...
        _this133 = _super145.call(this, parameters, LocalRelativeObjectIdentifierValueBlock);
        _this133.idBlock.tagClass = 1;
        _this133.idBlock.tagNumber = 13;
        return _this133;
      }
    ...
    var LocalBmpStringValueBlock = function (_HexBlock18) {
      ...
      var _super146 = _createSuper(LocalBmpStringValueBlock);
      ...
      function LocalBmpStringValueBlock() {
        ...
        _this134 = _super146.call(this, parameters);
        _this134.isHexOnly = true;
        _this134.value = "";
        return _this134;
      }
    ...
    var BmpString = function (_BaseBlock26) {
      ...
      var _super147 = _createSuper(BmpString);
      ...
      function BmpString() {
        ...
        _this135 = _super147.call(this, parameters, LocalBmpStringValueBlock);
        if ("value" in parameters) _this135.fromString(parameters.value);
        _this135.idBlock.tagClass = 1;
        _this135.idBlock.tagNumber = 30;
        return _this135;
      }
      ...
      _createClass(BmpString, [{
        ...
        value: function fromString(inputString) {
          ...
          for (var i = 0; i < strLength; i++) {
            var codeBuf = (0, utils$1.utilToBase)(inputString.charCodeAt(i), 8);
            var codeView = new Uint8Array(codeBuf);
            if (codeView.length > 2) continue;
            var dif = 2 - codeView.length;
    ...
    var LocalUniversalStringValueBlock = function (_HexBlock19) {
      ...
      var _super148 = _createSuper(LocalUniversalStringValueBlock);
      ...
      function LocalUniversalStringValueBlock() {
        ...
        _this136 = _super148.call(this, parameters);
        _this136.isHexOnly = true;
        _this136.value = "";
        return _this136;
      }
    ...
    var UniversalString = function (_BaseBlock27) {
      ...
      var _super149 = _createSuper(UniversalString);
      ...
      function UniversalString() {
        ...
        _this137 = _super149.call(this, parameters, LocalUniversalStringValueBlock);
        if ("value" in parameters) _this137.fromString(parameters.value);
        _this137.idBlock.tagClass = 1;
        _this137.idBlock.tagNumber = 28;
        return _this137;
      }
    ...
    var LocalSimpleStringValueBlock = function (_HexBlock20) {
      ...
      var _super150 = _createSuper(LocalSimpleStringValueBlock);
      ...
      function LocalSimpleStringValueBlock() {
        ...
        _this138 = _super150.call(this, parameters);
        _this138.value = "";
        _this138.isHexOnly = true;
        return _this138;
      }
    ...
    var LocalSimpleStringBlock = function (_BaseBlock28) {
      ...
      var _super151 = _createSuper(LocalSimpleStringBlock);
      ...
      function LocalSimpleStringBlock() {
        ...
        _this139 = _super151.call(this, parameters, LocalSimpleStringValueBlock);
        if ("value" in parameters) _this139.fromString(parameters.value);
        return _this139;
      }
    ...
    var NumericString = function (_LocalSimpleStringBlo10) {
      ...
      var _super152 = _createSuper(NumericString);
      ...
      function NumericString() {
        ...
        _this140 = _super152.call(this, parameters);
        _this140.idBlock.tagClass = 1;
        _this140.idBlock.tagNumber = 18;
        return _this140;
      }
    ...
    var PrintableString = function (_LocalSimpleStringBlo11) {
      ...
      var _super153 = _createSuper(PrintableString);
      ...
      function PrintableString() {
        ...
        _this141 = _super153.call(this, parameters);
        _this141.idBlock.tagClass = 1;
        _this141.idBlock.tagNumber = 19;
        return _this141;
      }
    ...
    var TeletexString = function (_LocalSimpleStringBlo12) {
      ...
      var _super154 = _createSuper(TeletexString);
      ...
      function TeletexString() {
        ...
        _this142 = _super154.call(this, parameters);
        _this142.idBlock.tagClass = 1;
        _this142.idBlock.tagNumber = 20;
        return _this142;
      }
    ...
    var VideotexString = function (_LocalSimpleStringBlo13) {
      ...
      var _super155 = _createSuper(VideotexString);
      ...
      function VideotexString() {
        ...
        _this143 = _super155.call(this, parameters);
        _this143.idBlock.tagClass = 1;
        _this143.idBlock.tagNumber = 21;
        return _this143;
      }
    ...
    var IA5String = function (_LocalSimpleStringBlo14) {
      ...
      var _super156 = _createSuper(IA5String);
      ...
      function IA5String() {
        ...
        _this144 = _super156.call(this, parameters);
        _this144.idBlock.tagClass = 1;
        _this144.idBlock.tagNumber = 22;
        return _this144;
      }
    ...
    var GraphicString = function (_LocalSimpleStringBlo15) {
      ...
      var _super157 = _createSuper(GraphicString);
      ...
      function GraphicString() {
        ...
        _this145 = _super157.call(this, parameters);
        _this145.idBlock.tagClass = 1;
        _this145.idBlock.tagNumber = 25;
        return _this145;
      }
    ...
    var VisibleString = function (_LocalSimpleStringBlo16) {
      ...
      var _super158 = _createSuper(VisibleString);
      ...
      function VisibleString() {
        ...
        _this146 = _super158.call(this, parameters);
        _this146.idBlock.tagClass = 1;
        _this146.idBlock.tagNumber = 26;
        return _this146;
      }
    ...
    var GeneralString = function (_LocalSimpleStringBlo17) {
      ...
      var _super159 = _createSuper(GeneralString);
      ...
      function GeneralString() {
        ...
        _this147 = _super159.call(this, parameters);
        _this147.idBlock.tagClass = 1;
        _this147.idBlock.tagNumber = 27;
        return _this147;
      }
    ...
    var CharacterString = function (_LocalSimpleStringBlo18) {
      ...
      var _super160 = _createSuper(CharacterString);
      ...
      function CharacterString() {
        ...
        _this148 = _super160.call(this, parameters);
        _this148.idBlock.tagClass = 1;
        _this148.idBlock.tagNumber = 29;
        return _this148;
      }
    ...
    var UTCTime = function (_VisibleString3) {
      ...
      var _super161 = _createSuper(UTCTime);
      ...
      function UTCTime() {
        ...
        _this149 = _super161.call(this, parameters);
        _this149.year = 0;
        _this149.month = 0;
        _this149.day = 0;
        _this149.hour = 0;
        ...
        if ("value" in parameters) {
          _this149.fromString(parameters.value);

          _this149.valueBlock.valueHex = new ArrayBuffer(parameters.value.length);
          var view = new Uint8Array(_this149.valueBlock.valueHex);
        ...
        if ("valueDate" in parameters) {
          _this149.fromDate(parameters.valueDate);

          _this149.valueBlock.valueHex = _this149.toBuffer();
        }

        _this149.idBlock.tagClass = 1;
        _this149.idBlock.tagNumber = 23;
        return _this149;
      }
      ...
      _createClass(UTCTime, [{
        ...
        value: function toString() {
          var outputArray = new Array(7);
          outputArray[0] = (0, utils$1.padNumber)(this.year < 2000 ? this.year - 1900 : this.year - 2000, 2);
          outputArray[1] = (0, utils$1.padNumber)(this.month, 2);
          outputArray[2] = (0, utils$1.padNumber)(this.day, 2);
          outputArray[3] = (0, utils$1.padNumber)(this.hour, 2);
          outputArray[4] = (0, utils$1.padNumber)(this.minute, 2);
          outputArray[5] = (0, utils$1.padNumber)(this.second, 2);
          outputArray[6] = "Z";
          return outputArray.join("");
        }
      }, {
    ...
    var GeneralizedTime = function (_VisibleString4) {
      ...
      var _super162 = _createSuper(GeneralizedTime);
      ...
      function GeneralizedTime() {
        ...
        _this150 = _super162.call(this, parameters);
        _this150.year = 0;
        _this150.month = 0;
        _this150.day = 0;
        _this150.hour = 0;
        _this150.minute = 0;
        _this150.second = 0;
        _this150.millisecond = 0;

        if ("value" in parameters) {
          _this150.fromString(parameters.value);

          _this150.valueBlock.valueHex = new ArrayBuffer(parameters.value.length);
          var view = new Uint8Array(_this150.valueBlock.valueHex);
        ...
        if ("valueDate" in parameters) {
          _this150.fromDate(parameters.valueDate);

          _this150.valueBlock.valueHex = _this150.toBuffer();
        }

        _this150.idBlock.tagClass = 1;
        _this150.idBlock.tagNumber = 24;
        return _this150;
      }
      ...
      _createClass(GeneralizedTime, [{
        ...
        value: function toString() {
          var outputArray = [];
          outputArray.push((0, utils$1.padNumber)(this.year, 4));
          outputArray.push((0, utils$1.padNumber)(this.month, 2));
          outputArray.push((0, utils$1.padNumber)(this.day, 2));
          outputArray.push((0, utils$1.padNumber)(this.hour, 2));
          outputArray.push((0, utils$1.padNumber)(this.minute, 2));
          outputArray.push((0, utils$1.padNumber)(this.second, 2));

          if (this.millisecond !== 0) {
            outputArray.push(".");
            outputArray.push((0, utils$1.padNumber)(this.millisecond, 3));
          }
    ...
    var DATE = function (_Utf8String6) {
      ...
      var _super163 = _createSuper(DATE);
      ...
      function DATE() {
        ...
        _this151 = _super163.call(this, parameters);
        _this151.idBlock.tagClass = 1;
        _this151.idBlock.tagNumber = 31;
        return _this151;
      }
    ...
    var TimeOfDay = function (_Utf8String7) {
      ...
      var _super164 = _createSuper(TimeOfDay);
      ...
      function TimeOfDay() {
        ...
        _this152 = _super164.call(this, parameters);
        _this152.idBlock.tagClass = 1;
        _this152.idBlock.tagNumber = 32;
        return _this152;
      }
    ...
    var DateTime = function (_Utf8String8) {
      ...
      var _super165 = _createSuper(DateTime);
      ...
      function DateTime() {
        ...
        _this153 = _super165.call(this, parameters);
        _this153.idBlock.tagClass = 1;
        _this153.idBlock.tagNumber = 33;
        return _this153;
      }
    ...
    var Duration = function (_Utf8String9) {
      ...
      var _super166 = _createSuper(Duration);
      ...
      function Duration() {
        ...
        _this154 = _super166.call(this, parameters);
        _this154.idBlock.tagClass = 1;
        _this154.idBlock.tagNumber = 34;
        return _this154;
      }
    ...
    var TIME = function (_Utf8String10) {
      ...
      var _super167 = _createSuper(TIME);
      ...
      function TIME() {
        ...
        _this155 = _super167.call(this, parameters);
        _this155.idBlock.tagClass = 1;
        _this155.idBlock.tagNumber = 14;
        return _this155;
      }
    ...
    var Choice = function Choice() {
      ...
      this.value = (0, utils$1.getParametersValue)(parameters, "value", []);
      this.optional = (0, utils$1.getParametersValue)(parameters, "optional", false);
    };
    ...
    var Any = function Any() {
      ...
      this.name = (0, utils$1.getParametersValue)(parameters, "name", "");
      this.optional = (0, utils$1.getParametersValue)(parameters, "optional", false);
    };
    ...
    var Repeated = function Repeated() {
      ...
      this.name = (0, utils$1.getParametersValue)(parameters, "name", "");
      this.optional = (0, utils$1.getParametersValue)(parameters, "optional", false);
      this.value = (0, utils$1.getParametersValue)(parameters, "value", new Any());
      this.local = (0, utils$1.getParametersValue)(parameters, "local", false);
    };
    ...
    var RawData = function () {
      function RawData() {
        ...
        this.data = (0, utils$1.getParametersValue)(parameters, "data", new ArrayBuffer(0));
      }
    ...
    function LocalFromBER(inputBuffer, inputOffset, inputLength) {
      ...
      if ((0, utils$1.checkBufferParams)(baseBlock, inputBuffer, inputOffset, inputLength) === false) {
        returnObject.error = baseBlock.error;
        return {
          offset: -1,
          result: returnObject
    ...
    function compareSchema(root, inputData, inputSchema) {
      ...
      if (inputSchema.idBlock.isConstructed === true) {
        ...
        if (inputData.valueBlock.value.length === 0 && inputSchema.valueBlock.value.length !== 0) {
          ...
          for (var _i53 = 0; _i53 < inputSchema.valueBlock.value.length; _i53++) {
            _optional = _optional && (inputSchema.valueBlock.value[_i53].optional || false);
          }
        ...
        for (var _i54 = 0; _i54 < maxLength; _i54++) {
          if (_i54 - admission >= inputData.valueBlock.value.length) {
            if (inputSchema.valueBlock.value[_i54].optional === false) {
              var _result7 = {
                verified: false,
                result: root
              };
              ...
              if (inputSchema.valueBlock.value[0] instanceof Repeated) {
                _result6 = compareSchema(root, inputData.valueBlock.value[_i54], inputSchema.valueBlock.value[0].value);
                ...
                if ("name" in inputSchema.valueBlock.value[0] && inputSchema.valueBlock.value[0].name.length > 0) {
                  ...
                  if ("local" in inputSchema.valueBlock.value[0] && inputSchema.valueBlock.value[0].local === true) arrayRoot = inputData;else arrayRoot = root;
                  if (typeof arrayRoot[inputSchema.valueBlock.value[0].name] === "undefined") arrayRoot[inputSchema.valueBlock.value[0].name] = [];
                  arrayRoot[inputSchema.valueBlock.value[0].name].push(inputData.valueBlock.value[_i54]);
                }
              } else {
                  _result6 = compareSchema(root, inputData.valueBlock.value[_i54 - admission], inputSchema.valueBlock.value[_i54]);

                  if (_result6.verified === false) {
                    if (inputSchema.valueBlock.value[_i54].optional === true) admission++;else {
                      if (inputSchema.hasOwnProperty("name")) {
                        inputSchema.name = inputSchema.name.replace(/^\s+|\s+$/g, "");
                        if (inputSchema.name !== "") delete root[inputSchema.name];
                      }
  ...
  exports.X509IssuerSerial = function (_XmlSignatureObject10) {
    ...
    var _super168 = _createSuper(X509IssuerSerial);
  ...
  exports.KeyInfoX509Data = function (_KeyInfoClause4) {
    ...
    var _super169 = _createSuper(KeyInfoX509Data);
  ...
  exports.SPKIData = function (_KeyInfoClause5) {
    ...
    var _super170 = _createSuper(SPKIData);
    ...
    _createClass(SignedXml, [{
      ...
      value: function () {
        var _DigestReference = _asyncToGenerator(regeneratorRuntime.mark(function _callee20(doc, reference, checkHmac) {
          var objectName, uri, found, xmlSignatureObjects, _i55, _xmlSignatureObjects, xmlSignatureObject, el, parent, _el, canonOutput, excC14N, digest;
            ...
            while (1) {
              switch (_context20.prev = _context20.next) {
                case 0:
                  ...
                  _i55 = 0, _xmlSignatureObjects = xmlSignatureObjects;

                case 7:
                  if (!(_i55 < _xmlSignatureObjects.length)) {
                    _context20.next = 22;
                    break;
                  }

                  xmlSignatureObject = _xmlSignatureObjects[_i55];
